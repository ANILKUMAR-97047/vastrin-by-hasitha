...
export default function CoutureCollections() {
  return (
    ...
    <section className="bg-[#fdf2f2] py-8 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto font-inknut">

        {/* Main Section Heading */}
        <h2 className="mb-10 text-center text-[20px] sm:text-[24px] md:text-[28px] lg:text-[32px] font-normal uppercase  text-[#E01A69]">
