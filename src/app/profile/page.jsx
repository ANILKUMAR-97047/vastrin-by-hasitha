...
const ProfileSettings = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!emailRegex.test(formData.email)) return toast.error("Please enter a valid Email Id");

        if (!formData.phoneNumber.trim()) return toast.error("Phone Number is required");
        if (!formData.alternatePhoneNumber.trim()) return toast.error("Alternate Phone Number is required");
