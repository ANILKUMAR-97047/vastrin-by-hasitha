    ...
    return (
        <div className="flex flex-col font-inknut text-gray-800 space-y-6">
            ...
            <div className="space-y-2">
                <p className="text-[10px] md:text-xs text-gray-500 uppercase tracking-widest">{product.brand}</p>
            ...
            <div className="flex items-center gap-1 text-[#D4AF37] text-sm">
                <span>★★★★★</span>
                <span className="text-gray-500 text-xs ml-2">5.0 / 5 ({product.reviewCount})</span>
            </div>
            ...
            <div className="space-y-4 pt-4">
                ...
                <div className="flex items-center border border-gray-300 w-fit">
                    <button onClick={() => handleQuantity('dec')} className="px-4 py-2 hover:bg-gray-100 transition">-</button>
                    <span className="px-4 py-2 font-bold min-w-12 text-center">{quantity}</span>
                    <button onClick={() => handleQuantity('inc')} className="px-4 py-2 hover:bg-gray-100 transition">+</button>
                </div>
            ...
            <div className="pt-6 font-inria">
                <p className="text-center font-bold text-sm mb-4">Secure Checkout with</p>
